...
;       A - lines count
draw_bitmap_NOT_AND_blitted_vram:
	push hl
	push bc
	push af
	ld a, (hl)
	ld ixh, a
	call draw_line_NOT_AND_blitted_vram
	pop af
	pop bc
	pop hl
	...
	dec a
	cp 0
	jp nz, draw_bitmap_NOT_AND_blitted_vram
...
;	  IXL - screen X coordinate
;     IXH - line data
draw_line_NOT_AND_blitted_vram:
	...
	jp z, na_spans_only_one_square_vram	; when x coordinate is a multiple of 8,
...
na_shift_line_data_left_vram_loop:
	sla c
	dec a
	jp nz, na_shift_line_data_left_vram_loop
