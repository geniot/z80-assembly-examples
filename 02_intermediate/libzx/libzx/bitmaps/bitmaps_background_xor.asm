...
;       A - lines count
draw_bitmap_XOR_blitted_background:
	push hl
	push bc
	push af
	ld a, (hl)
	ld ixh, a
	call draw_line_XOR_blitted_background
	pop af
	pop bc
	pop hl
	...
	dec a
	cp 0
	jp nz, draw_bitmap_XOR_blitted_background
...
;	  IXL - screen X coordinate
;     IXH - line data
draw_line_XOR_blitted_background:
	...
	jp z, x_spans_only_one_square ; when x coordinate is a multiple of 8,
...
x_shift_line_data_left_loop:
	sla c
	dec a
	jp nz, x_shift_line_data_left_loop
