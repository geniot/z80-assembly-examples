...
BUFFER_TO_SCREEN_OFFSET equ VISIBLE_VIDEO_MEMORY - backgroundVideoBuffer
	...
	; Includes
	;--------------------------------------------------------------------------
	include "bitmaps/bitmaps_vram.asm"
	include "bitmaps/bitmaps_background.asm"
	
	include "bitmaps/bitmaps_vram_or_masked.asm"
	include "bitmaps/bitmaps_vram_or.asm"
	include "bitmaps/bitmaps_vram_xor.asm"
	include "bitmaps/bitmaps_vram_not_and.asm"
	
	include "bitmaps/bitmaps_background_or.asm"
	include "bitmaps/bitmaps_background_xor.asm"
	include "bitmaps/bitmaps_background_not_and.asm"
	include "bitmaps/bitmaps_background_or_masked.asm"
	
	include "bitmaps/bitmaps_buffer.asm"
	include "bitmaps/bitmaps_utilities.asm"
	include "bitmaps/bitmaps_colours.asm"
