...
; https://skoolkit.ca
;
; © 1983 Bug-Byte Ltd (Manic Miner)
; © 2010, 2012-2023, 2025, 2026 Richard Dymond (this disassembly)
...
; Willy's actual pixel y-coordinate.
WILLY_Y:
  DEFB 0
...
;
; Used by the routines at main, LOOP and ENDGAM.
;
...
; to start falling.
  ...
  LD (AIRBORNE),A         ;
  RLCA                    ; The value of D determines the pitch of the falling
  RLCA                    ; sound effect
  RLCA                    ;
  RLCA                    ;
  LD D,A                  ;
...
MOVEWILLY_6:
  ...
  ADD A,8                 ; moves Willy downwards by 4 pixels
  LD (WILLY_Y),A          ;
MOVEWILLY_7:
...
MOVEWILLY_10:
  ...
  ADD A,16                ; top row of cells of his sprite is just below the
  AND 240                 ; wall tile
  LD (WILLY_Y),A          ;
  CALL MOVEWILLY_7        ; Adjust Willy's attribute buffer location at
...
; initial location and appearance in the cavern.
  DEFB 208                ; Pixel y-coordinate * 2 (see WILLY_Y)
...
; The next seven bytes are copied to 32872-32878 and specify Miner Willy's
; initial location and appearance in the cavern.
  DEFB 48                 ; Pixel y-coordinate * 2 (see WILLY_Y)
  DEFB 0                  ; Animation frame (see FRAME)
  DEFB 0                  ; Direction and movement flags: facing right (see
                          ; DMFLAGS)
  DEFB 0                  ; Airborne status indicator (see AIRBORNE)
...
; The next seven bytes are copied to 32872-32878 and specify Miner Willy's
; initial location and appearance in the cavern.
  DEFB 64                 ; Pixel y-coordinate * 2 (see WILLY_Y)
  DEFB 0                  ; Animation frame (see FRAME)
  DEFB 0                  ; Direction and movement flags: facing right (see
                          ; DMFLAGS)
  DEFB 0                  ; Airborne status indicator (see AIRBORNE)
...
; The next seven bytes are copied to 32872-32878 and specify Miner Willy's
; initial location and appearance in the cavern.
  DEFB 16                 ; Pixel y-coordinate * 2 (see WILLY_Y)
  DEFB 0                  ; Animation frame (see FRAME)
  DEFB 0                  ; Direction and movement flags: facing right (see
                          ; DMFLAGS)
  DEFB 0                  ; Airborne status indicator (see AIRBORNE)
...
; The next seven bytes are copied to 32872-32878 and specify Miner Willy's
; initial location and appearance in the cavern.
  DEFB 160                ; Pixel y-coordinate * 2 (see WILLY_Y)
  DEFB 0                  ; Animation frame (see FRAME)
  DEFB 0                  ; Direction and movement flags: facing right (see
                          ; DMFLAGS)
  DEFB 0                  ; Airborne status indicator (see AIRBORNE)
